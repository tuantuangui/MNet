...
pZscore <- function(object,group,tumor_color="#d53e4f",normal_color="#7FC8A9",shape_size=3,ysize=5) {
  ...
  p <- ggplot2::ggplot(object_melt_group,ggplot2::aes(label,value,color=group))+
