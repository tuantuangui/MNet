        ...
        #=== 1.2 bs4DashSidebar
        {
            sidebar = bs4DashSidebar(
                ...
                bs4SidebarMenu(
                    ...
                    br(),
                    bs4SidebarMenuItem(
                        text="3. Routine Analysers",
                        tabName=NULL,
                        href = NULL,
                        newTab = TRUE,
                        selected = NULL,
                        expandedName = "routine_analysis",
                        startExpanded = TRUE,
                        condition = NULL,
                        bs4SidebarMenuSubItem(
                          text = "| Name Transform",
                          tabName = "name_transform",
                          href = NULL,
                          newTab = TRUE,
                          icon = icon("r-project"),
                          selected = NULL
                        ...
                        bs4SidebarMenuSubItem(
                          text = "| Group-wise Analyser",
                          tabName = "group_analysis",
                          href = NULL,
                          newTab = TRUE,
                          icon = icon("r-project"),
                          selected = NULL
                        ...
                        bs4SidebarMenuSubItem(
                          text = "| Clinical Analysers",
                          tabName = "clinical_analysis",
                          href = NULL,
                          newTab = TRUE,
                          icon = icon("r-project"),
                          selected = NULL
