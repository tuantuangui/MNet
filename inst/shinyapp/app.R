                               ...
                               fluidRow(
                                   ...
                                   column(
                                       ...
                                       bs4TabCard(
                                           # ribbon(text = "User", color = "danger"),
                                           id = "examples_tabbox",
                                           selected = "Output: Pathway ID Data",
                                           title = tags$b("User", style = "color: #aaaaaa;"),
                                           width = 12,
                                           height = 800,
                                           side = "right",
...
server <- shinyServer(function(session, input, output) {
    ...
    # name2refmet
    {
        ...
        observeEvent(input$name2refmet_submit, {
            ...
            name_data <- strsplit(input$name2refmet_user_name_data_input,"\n")[[1]]
    ...
    # name2keggid
    {
        ...
        observeEvent(input$name2keggid_submit, {
            ...
            name_data <- strsplit(input$name2keggid_user_name_data_input,"\n")[[1]]
    ...
    # name2pathway
    {
        ...
        observeEvent(input$name2pathway_submit, {
            ...
            name_data <- strsplit(input$name2pathway_user_name_data_input,"\n")[[1]]
    ...
    # keggid2pathway
    {
        ...
        observeEvent(input$keggid2pathway_submit, {
            ...
            keggid_data <- strsplit(input$keggid2pathway_user_keggid_data_input,"\n")[[1]]
