...
kable(head(result$gene_info[1:2,]))
kable(head(result$compound_info[1:2,]))
```
...
```{r fig.keep='all', PCA, warning=FALSE, fig.width=10.00, fig.height=6.18}
### the pca plot
...
```{r fig.keep='all', pVolcano, warning=FALSE, fig.width=10.00, fig.height=6.18}
...
```{r fig.keep='all', pHeatmap, warning=FALSE, fig.width=10.00, fig.height=6.18}
...
```{r fig.keep='all', pZscore, warning=FALSE, fig.width=10.00, fig.height=6.18}
...
```{r fig.keep='all', pCliTS, warning=FALSE, fig.width=10.00, fig.height=6.18}
clinical_index[1:5,]
...
```{r fig.keep='all', survCli, warning=FALSE, fig.width=10.00, fig.height=6.18}
names(aml)[3] ="group"
p=survCli(aml)
p
```
