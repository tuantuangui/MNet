...
```{r fig.keep='all', network, warning=FALSE, fig.width=10.00, fig.height=6.18}
...
```{r fig.keep='all', network_diff, warning=FALSE, fig.width=10.00, fig.height=6.18}
...
```{r fig.keep='all', network_corr, warning=FALSE, fig.width=10.00, fig.height=6.18}
...
a
# dev.off()
write.table(a$result,"result_v0131/subnetwork_correlation.txt",quote=F,row.names=F,sep="\t")
```
